...
def returnBook(): 
    ...
    headingLabel = Label(headingFrame1, text="Return Book", bg='pale green', fg='black', font=('Times New Roman',22))
    ...
    #Submit Button
    SubmitBtn = Button(root,text="Return",bg='green', fg='white',command=returnn, font=('times new roman',16))
